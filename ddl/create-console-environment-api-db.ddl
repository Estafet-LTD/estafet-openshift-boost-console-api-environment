...
create table APP (APP_ID int8 not null, DEPLOYED boolean not null, DEPLOYED_DATE varchar(255), APP_NAME varchar(255) not null, UPDATED_DATE varchar(255) not null, VERSION varchar(255) not null, ENV_ID varchar(255) not null, primary key (APP_ID));
