...
create table Product (PRODUCT_ID varchar(255) not null, DESCRIPTION varchar(255) not null, UPDATED_DATE varchar(255) not null, VERSION varchar(255) not null, primary key (PRODUCT_ID));
